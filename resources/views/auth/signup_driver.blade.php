    ...
    <div class="max-w-4xl gap-6  h-full w-full bg-white rounded-2xl shadow-2xl flex flex-col px-8 py-12">
        <form action="{{ route('signup.driver') }}" class="space-y-10" method="POST">
            ...
            <div class="flex flex-col items-center gap-4 pt-4">
                ...
                <div class="text-center mt-2"> <p class="text-sm text-gray-700 font-medium">Already have an account? <a href="{{ route('login') }}" class="text-blue-600 underline ml-1">Login</a></p> </div>
            </div>
        </form>
    </div>
</div>
