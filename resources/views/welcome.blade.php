    ...
    <div class="max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-default rounded-base bg-neutral-secondary-soft md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-neutral-primary">
                ...
                <li>
                    <a href="/login" class=" p-2 px-4 text-sm rounded bg-green-500 hover:bg-green-600 text-white  ">Access Portal</a>
...
<main class="  max-w-screen-2xl mx-auto flex-1 flex flex-col overflow-y-auto">
    <section class="h-screen min-h-0 bg-gray-50 grid md:grid-cols-2 px-4">
        <div class="flex flex-col p-8 justify-center ">
            <h1 class="text-2xl md:text-4xl text-gray-800 font-medium text-left tracking-wider"><span class="font-bold text-green-500">SMART TRIKE: </span>
            ...
            <a href="/login" class="px-4 py-2 rounded mt-4 text-white text-sm font-bold shadow-xs hover:bg-green-600 flex items-center justify-center bg-green-500  transition duration-200 w-42">Access Portal</a>
        </div>
    ...
    <section id="features" class="h-auto md:h-screen min-h-0 items-center justify-center flex flex-col bg-white p-8 md:px-24">
        <h3 class="text-green-500 font-bold text-center text-sm">FEATURES</h3>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-7">
            <div class="h-auto md:h-36 items-start justify-center bg-gray-50 rounded-2xl border border-gray-200 p-4 flex flex-col">
                <div class="h-8">
                    <x-pepicon-people class="h-6 text-green-500" />
                </div>
            ...
            <div class="h-auto md:h-36 items-start justify-center bg-gray-50 rounded-2xl border border-gray-200 p-4 flex flex-col">
                <div class="h-8">
                    <x-clarity-license-solid class="h-6 text-green-500" />
            ...
            <div class="h-auto md:h-36 items-start justify-center bg-gray-50 rounded-2xl border border-gray-200 p-4 flex flex-col">
                <div class="h-8">
                    <x-heroicon-o-shield-check class="h-6 text-green-500" />
            ...
            <div class="h-auto md:h-36 items-start justify-center bg-gray-50 rounded-2xl border border-gray-200 p-4 flex flex-col">
                <div class="h-8">
                    <x-gmdi-color-lens-o class="h-6 text-green-500" />
            ...
            <div class="h-auto md:h-36 items-start justify-center bg-gray-50 rounded-2xl border border-gray-200 p-4 flex flex-col">
                <div class="h-8">
                    <x-ri-layout-2-line class="h-6 text-green-500" />
            ...
            <div class="h-auto md:h-36 items-start justify-center bg-gray-50 rounded-2xl border border-gray-200 p-4 flex flex-col">
                <div class="h-8">
                    <x-tabler-report class="h-6 text-green-500" />
